...
| :--- | :--- | :--- |
| **`/`** | `Home.tsx` | Overview Dashboard. Features dual-tracks (Beginners vs. Experts) and a date-seeded "Fact of the Day" widget rotating through the site's own trivia and Encyclopedia analogies (`src/lib/home/factOfTheDay.ts`). |
