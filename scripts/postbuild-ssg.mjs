...
const ROUTES = [
  ...
  { path: '/playground/business-wallet', title: 'Business Wallet Studio — Organizations as Credential Holders', description: 'Set up an organizational wallet: choose a custody model, receive a credential, delegate presentation authority to employees, and present it to a verifier — then inject a departed employee, a mid-transaction revocation, and a threshold violation to test governance.' },
  { path: '/playground/credential-issuance', title: 'Credential Issuance Studio — Play the Issuer Role', description: 'Define a credential type, configure issuance (holder binding, validity window, revocation), issue to a simulated holder wallet, verify from the verifier side, then revoke and observe the propagation lag and privacy trade-offs of status-list revocation.' },
  ...
  { path: '/tools/crypto-agility-inventory', title: 'Crypto Agility Inventory Builder', description: 'Record cryptographic dependencies across your identity estate — algorithm, key length, rotation capability, HNDL exposure, migration difficulty — and get a prioritized migration backlog with CSV/JSON export.' },
]
