...
const ROUTES = [
  ...
  { path: '/architecture', title: 'Interactive Architecture Center', description: 'Explore secure, clickable, in-browser reference architectures for Zero Trust, B2B SaaS tenancy, and Multi-Cloud identities.' },
  { path: '/vendor', title: 'Vendor Knowledge Center', description: 'Deep-dive reference guides, architectures, certification plans, and interview questions for Microsoft Entra, Okta, Keycloak, CyberArk, and Ping Identity.' },
