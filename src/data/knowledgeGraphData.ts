...
export const KNOWLEDGE_GRAPH_EDGES: [string, string][] = [
  ...
  ['standard:mcp', 'standard:oauth21'],
  ['standard:mcp', 'standard:rfc9396-rar'],
  ['standard:rfc9396-rar', 'standard:oauth21'],
  ['standard:rfc9396-rar', 'standard:rfc8693'],
  ['standard:ciba', 'standard:oidc'],
  ['standard:agent-authz-emerging', 'standard:rfc8693'],
  ['standard:agent-authz-emerging', 'standard:rfc9396-rar'],
  ['standard:fido-fdo', 'standard:webauthn'],
  ['standard:eidas2-arf', 'standard:vc-did'],
  ['standard:eidas2-arf', 'standard:openid4vc'],
  ['standard:openid4vci', 'standard:openid4vc'],
  ['standard:openid4vci', 'standard:vc-did'],
  ['standard:pqc-fips203-205', 'standard:x509-pki'],
  ['standard:pqc-fips203-205', 'standard:jose'],
  ...
  ['standard:mcp', 'term:mcp'],
  ['standard:mcp', 'term:agentic_ai'],
  ['standard:mcp', 'term:tool_calling_authorization'],
  ['standard:rfc9396-rar', 'term:declared_intent'],
  ['standard:rfc9396-rar', 'term:ai_agent_identity'],
  ['standard:ciba', 'term:on_behalf_of'],
  ['standard:agent-authz-emerging', 'term:agentic_ai'],
  ['standard:fido-fdo', 'term:authenticator_lifecycle'],
  ['standard:webauthn', 'term:enterprise_attestation'],
  ['standard:webauthn', 'term:aaguid'],
  ['standard:nist80063', 'term:phishing_resistant_mfa'],
  ['standard:eidas2-arf', 'term:business_wallet'],
  ['standard:eidas2-arf', 'term:relying_party_obligation'],
  ['standard:openid4vci', 'term:credential_issuer'],
  ['standard:openid4vc', 'term:status_list_revocation'],
  ['standard:pqc-fips203-205', 'term:crypto_agility'],
  ['standard:pqc-fips203-205', 'term:harvest_now_decrypt_later'],
  ['standard:x509-pki', 'term:hardware_root_of_trust'],
  ...
  ['term:ai_agent_identity', 'term:agent_registry'],
  ['term:ai_agent_identity', 'term:declared_intent'],
  ['term:ai_agent_identity', 'term:agent_owner'],
  ['term:ai_agent_identity', 'term:on_behalf_of'],
  ['term:agentic_ai', 'term:ai_agent_identity'],
  ['term:agentic_ai', 'term:mcp'],
  ['term:agentic_ai', 'term:shadow_ai'],
  ['term:task_drift', 'term:ai_control_plane'],
  ['term:task_drift', 'term:semantic_guardrail'],
  ['term:task_drift', 'term:declared_intent'],
  ['term:prompt_injection', 'term:ai_firewall'],
  ['term:prompt_injection', 'term:agentic_ai'],
  ['term:semantic_guardrail', 'term:ai_firewall'],
  ['term:ai_control_plane', 'term:ai_firewall'],
  ['term:ai_control_plane', 'term:shadow_ai'],
  ['term:enterprise_attestation', 'term:aaguid'],
  ['term:phishing_resistant_mfa', 'term:passkey'],
  ['term:phishing_resistant_mfa', 'term:authenticator_lifecycle'],
  ['term:business_wallet', 'term:credential_issuer'],
  ['term:business_wallet', 'term:relying_party_obligation'],
  ['term:credential_issuer', 'term:status_list_revocation'],
  ['term:relying_party_obligation', 'term:vc'],
  ['term:hardware_root_of_trust', 'term:crypto_agility'],
  ['term:crypto_agility', 'term:harvest_now_decrypt_later'],
