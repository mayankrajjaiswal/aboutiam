...
const SIMULATORS_LIST = [
  ...
  { id: 'mpc-threshold', title: 'MPC Threshold Signature Scheme Sandbox', desc: 'Model Shamir\'s Secret Sharing to split, distribute, and combine cryptographic signature shards across separate user devices.', link: '/playground/mpc-threshold', kw: ['mpc', 'threshold', 'signature shard', 'shamir', 'secret sharing', 'lagrange'] },
  { id: 'zk-cross-chain', title: 'ZK Cross-Chain Auth Simulator', desc: 'Generate a browser-native zk-SNARK cryptographic proof of Web3 wallet holdings to authorize access to corporate Web2 APIs anonymously.', link: '/playground/zk-cross-chain', kw: ['zk-snark', 'cross-chain', 'web3', 'wallet holdings', 'anonymous', 'proof'] },
  { id: 'sybil-orb', title: 'Sybil-Resistant Iris Hash Lab', desc: 'Explore how biometric Gabor filter vectors generate secure, irreversible, Sybil-resistant Iris-Codes for Proof-of-Personhood.', link: '/playground/sybil-orb', kw: ['sybil', 'orb', 'iris scan', 'proof of personhood', 'gabor filter', 'merkle tree'] },
  { id: 'm2m-negotiator', title: 'M2M AI Protocol Negotiator', desc: 'Visualize autonomous AI agents executing smart-contract bids to negotiate custom-scoped OAuth 2.1 access rules dynamically.', link: '/playground/m2m-negotiator', kw: ['m2m', 'negotiator', 'ai agent', 'protocol negotiation', 'scope bargain', 'jwt life'] },
  { id: 'ocular-kinetic', title: 'Kinetic-Tremor Continuous Trust Simulator', desc: 'Model spatial computing continuous authentication by tracking microscopic hand tremors and involuntary eye saccades.', link: '/playground/ocular-kinetic', kw: ['kinetic-tremor', 'saccades', 'spatial computing', 'continuous trust', 'device handoff'] },
  { id: 'advanced-oauth-hack-defend', title: 'Advanced OAuth 2.1 Threat Modeling & Mitigation Simulator', desc: 'An interactive, multi-stage Hack-and-Defend sandbox. Simulate JWT Algorithm Confusion (forging RS256 with local HS256), PKCE bypass exploits, and wildcard redirect hijacking, and then apply modern OAuth 2.1 mitigations.', link: '/playground/advanced-oauth-hack-defend', kw: ['oauth 2.1', 'jwt algorithm confusion', 'pkce bypass', 'wildcard redirect', 'redirect hijacking', 'threat modeling', 'mitigation', 'hack and defend'] }
]
