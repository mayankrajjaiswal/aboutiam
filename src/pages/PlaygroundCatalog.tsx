...
export default function PlaygroundCatalog() {
  ...
  const playgrounds = [
    ...
    },
    {
      ...
      desc: "Simulate vector-level chunk metadata masking to authorize access to AI generated embeddings before the LLM synthesizes an answer.",
      icon: ScanSearch,
      link: "/playground/rag-authorization",
      badge: "Active (Next-Gen)",
    },
    {
      title: "Ephemeral AI Swarm Identity Orchestrator",
      desc: "Deploy an AI swarm and visualize constrained, short-lived tokens (RFC 8693) generated and revoked autonomously by a parent AI.",
      icon: Bot,
      link: "/playground/ai-swarm",
      badge: "Active (Next-Gen)",
    },
    {
      title: "Fully Homomorphic Encryption (FHE) Auth Sandbox",
      desc: "Perform mathematical polynomial intersection on encrypted ciphertexts to verify credentials without exposing the underlying plaintext.",
      icon: KeySquare,
      link: "/playground/fhe-auth",
      badge: "Active (Next-Gen)",
    },
    {
      title: "Quantum Key Distribution (QKD) Simulator",
      desc: "Observe the quantum state of photons collapsing during a transmission interception, compared to traditional lattice-based PQC.",
      icon: Radio,
      link: "/playground/qkd-simulator",
      badge: "Active (Next-Gen)",
    },
    {
      title: "ISO 18013-5 mDL Proximity Authentication Lab",
      desc: "Establish an offline secure BLE session using ECDH to pass a cryptographically signed CBOR payload without internet access.",
      icon: Smartphone,
      link: "/playground/mdl-proximity",
      badge: "Active (Next-Gen)",
    },
    {
      title: "Space Identity & DTN Simulator",
      desc: "Construct a Delay-Tolerant Networking (DTN) space identity packet and simulate store-and-forward authentication across planetary lag.",
      icon: Waypoints,
      link: "/playground/space-identity",
      badge: "Active (Next-Gen)",
    },
    {
      title: "V2X PKI Expressway Simulator",
      desc: "Simulate autonomous vehicles validating sub-10ms ephemeral pseudonymous certificates and rejecting invalid leaf-node brake signals.",
      icon: Activity,
      link: "/playground/v2x-pki",
      badge: "Active (Next-Gen)",
    },
    {
      title: "eBPF Kernel-Level Identity Tracer",
      desc: "Configure an eBPF ring-0 authorization policy and watch the kernel drop unauthorized network packets at the OS level.",
      icon: Terminal,
      link: "/playground/ebpf-tracer",
      badge: "Active (Next-Gen)",
    },
    {
      title: "Digital Twin Identity Binding Workbench",
      desc: "Cryptographically bond a Physical Unclonable Function (PUF) chip to an X.509 cloud certificate representing an IoT digital twin.",
      icon: Cpu,
      link: "/playground/digital-twin",
      badge: "Active (Next-Gen)",
    },
    {
      title: "BCI Neural Auth Baseline Simulator",
      desc: "Map a Brain-Computer Interface (BCI) P300 brainwave hash against a baseline for continuous spatial computing authentication.",
      icon: Glasses,
